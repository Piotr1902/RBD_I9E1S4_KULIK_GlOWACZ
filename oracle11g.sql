...
(
   ...
   IMIE_NAZWISKO        VARCHAR2(40)                 not null,
   ADRES                VARCHAR2(40),
   constraint PK_KLIENT primary key (ID_KLIENTA)
);

--wyświetlenie kolejno statusów paczki o id 7
select STATUS_PACZKI.ID_PACZKI, LOKALIZACJA.LOKALIZACJA, STATUS_PACZKI.DATA_CZAS
from STATUS_PACZKI,LOKALIZACJA
where STATUS_PACZKI.ID_LOKALIZACJI = LOKALIZACJA.ID_LOKALIZACJI and STATUS_PACZKI.ID_PACZKI = 7
order by STATUS_PACZKI.DATA_CZAS asc;

--pobranie numeru telefonu do kuriera, który jest odpowiedzialny za daną paczkę o id 7
select KURIER.TELEFON
from KURIER,PACZKA
where KURIER.ID_KURIERA = PACZKA.ID_KURIERA AND PACZKA.ID = 7;

--wyświetlenie wszystkich paczek, które nie zostały jeszcze doręczone
select ID_PACZKI as "Paczki niedoręczone"
from STATUS_PACZKI
where ID_PACZKI not in (select distinct ID_PACZKI from STATUS_PACZKI where ID_LOKALIZACJI = 1);

create table KURIER 
(
   ID_KURIERA           NUMBER               not null,
   IMIE_NAZWISKO        VARCHAR2(40)                 not null,
   TELEFON              VARCHAR2(40)                 not null,
   constraint PK_KURIER primary key (ID_KURIERA)
);

create table LOKALIZACJA 
(
   ID_LOKALIZACJI       NUMBER               not null,
   LOKALIZACJA          VARCHAR2(40)                 not null,
   constraint PK_LOKALIZACJA primary key (ID_LOKALIZACJI)
);

create table PACZKA 
(
   ID_PACZKI            NUMBER               not null,
   ID_KLIENTA           NUMBER,
   ID_KURIERA           NUMBER,
   ZAWARTOSC            VARCHAR2(40)                 not null,
   WARTOSC              NUMBER(8,2),
   constraint PK_PACZKA primary key (ID_PACZKI)
);

create index RELATIONSHIP_1_FK on PACZKA (
   ID_KLIENTA ASC
);

create index RELATIONSHIP_2_FK on PACZKA (
   ID_KURIERA ASC
);
...
create index RELATIONSHIP_3_FK on STATUS_PACZKI (
   ID_PACZKI ASC
);

create index RELATIONSHIP_4_FK on STATUS_PACZKI (
   ID_LOKALIZACJI ASC
);

alter table PACZKA
   add constraint FK_PACZKA_FK_PACZKA_KLIENT foreign key (ID_KLIENTA)
      references KLIENT (ID_KLIENTA);

alter table PACZKA
   add constraint FK_PACZKA_FK_PACZKA_KURIER foreign key (ID_KURIERA)
      references KURIER (ID_KURIERA);

alter table STATUS_PACZKI
   add constraint FK_STATUS_P_FK_STATUS_LOKALIZA foreign key (ID_LOKALIZACJI)
      references LOKALIZACJA (ID_LOKALIZACJI);

alter table STATUS_PACZKI
   add constraint FK_STATUS_P_FK_STATUS_PACZKA foreign key (ID_PACZKI)
      references PACZKA (ID_PACZKI);
...
INSERT INTO Status_paczki (id_statusu,id_paczki,id_lokalizacji,data_czas) VALUES (1,83,2,sysdate);
INSERT INTO Status_paczki (id_statusu,id_paczki,id_lokalizacji,data_czas) VALUES (2,47,1,sysdate);
INSERT INTO Status_paczki (id_statusu,id_paczki,id_lokalizacji,data_czas) VALUES (3,30,6,sysdate);
INSERT INTO Status_paczki (id_statusu,id_paczki,id_lokalizacji,data_czas) VALUES (4,36,8,sysdate);
INSERT INTO Status_paczki (id_statusu,id_paczki,id_lokalizacji,data_czas) VALUES (5,10,8,sysdate);
INSERT INTO Status_paczki (id_statusu,id_paczki,id_lokalizacji,data_czas) VALUES (6,100,2,sysdate);
INSERT INTO Status_paczki (id_statusu,id_paczki,id_lokalizacji,data_czas) VALUES (7,40,2,sysdate);
INSERT INTO Status_paczki (id_statusu,id_paczki,id_lokalizacji,data_czas) VALUES (8,76,5,sysdate);
INSERT INTO Status_paczki (id_statusu,id_paczki,id_lokalizacji,data_czas) VALUES (9,34,4,sysdate);
INSERT INTO Status_paczki (id_statusu,id_paczki,id_lokalizacji,data_czas) VALUES (10,10,7,sysdate);
INSERT INTO Status_paczki (id_statusu,id_paczki,id_lokalizacji,data_czas) VALUES (11,50,6,sysdate);
INSERT INTO Status_paczki (id_statusu,id_paczki,id_lokalizacji,data_czas) VALUES (12,40,4,sysdate);
INSERT INTO Status_paczki (id_statusu,id_paczki,id_lokalizacji,data_czas) VALUES (13,21,4,sysdate);
INSERT INTO Status_paczki (id_statusu,id_paczki,id_lokalizacji,data_czas) VALUES (14,13,8,sysdate);
INSERT INTO Status_paczki (id_statusu,id_paczki,id_lokalizacji,data_czas) VALUES (15,61,5,sysdate);
INSERT INTO Status_paczki (id_statusu,id_paczki,id_lokalizacji,data_czas) VALUES (16,78,6,sysdate);
INSERT INTO Status_paczki (id_statusu,id_paczki,id_lokalizacji,data_czas) VALUES (17,15,7,sysdate);
INSERT INTO Status_paczki (id_statusu,id_paczki,id_lokalizacji,data_czas) VALUES (18,15,2,sysdate);
INSERT INTO Status_paczki (id_statusu,id_paczki,id_lokalizacji,data_czas) VALUES (19,18,7,sysdate);
INSERT INTO Status_paczki (id_statusu,id_paczki,id_lokalizacji,data_czas) VALUES (20,50,4,sysdate);
INSERT INTO Status_paczki (id_statusu,id_paczki,id_lokalizacji,data_czas) VALUES (21,81,10,sysdate);
INSERT INTO Status_paczki (id_statusu,id_paczki,id_lokalizacji,data_czas) VALUES (22,85,1,sysdate);
INSERT INTO Status_paczki (id_statusu,id_paczki,id_lokalizacji,data_czas) VALUES (23,93,9,sysdate);
INSERT INTO Status_paczki (id_statusu,id_paczki,id_lokalizacji,data_czas) VALUES (24,3,7,sysdate);
INSERT INTO Status_paczki (id_statusu,id_paczki,id_lokalizacji,data_czas) VALUES (25,34,10,sysdate);
INSERT INTO Status_paczki (id_statusu,id_paczki,id_lokalizacji,data_czas) VALUES (26,68,3,sysdate);
INSERT INTO Status_paczki (id_statusu,id_paczki,id_lokalizacji,data_czas) VALUES (27,99,6,sysdate);
INSERT INTO Status_paczki (id_statusu,id_paczki,id_lokalizacji,data_czas) VALUES (28,4,2,sysdate);
INSERT INTO Status_paczki (id_statusu,id_paczki,id_lokalizacji,data_czas) VALUES (29,31,4,sysdate);
INSERT INTO Status_paczki (id_statusu,id_paczki,id_lokalizacji,data_czas) VALUES (30,96,2,sysdate);
INSERT INTO Status_paczki (id_statusu,id_paczki,id_lokalizacji,data_czas) VALUES (31,12,8,sysdate);
INSERT INTO Status_paczki (id_statusu,id_paczki,id_lokalizacji,data_czas) VALUES (32,89,10,sysdate);
INSERT INTO Status_paczki (id_statusu,id_paczki,id_lokalizacji,data_czas) VALUES (33,98,8,sysdate);
INSERT INTO Status_paczki (id_statusu,id_paczki,id_lokalizacji,data_czas) VALUES (34,7,6,sysdate);
INSERT INTO Status_paczki (id_statusu,id_paczki,id_lokalizacji,data_czas) VALUES (35,7,7,sysdate);
INSERT INTO Status_paczki (id_statusu,id_paczki,id_lokalizacji,data_czas) VALUES (36,49,9,sysdate);
INSERT INTO Status_paczki (id_statusu,id_paczki,id_lokalizacji,data_czas) VALUES (37,60,3,sysdate);
INSERT INTO Status_paczki (id_statusu,id_paczki,id_lokalizacji,data_czas) VALUES (38,22,10,sysdate);
INSERT INTO Status_paczki (id_statusu,id_paczki,id_lokalizacji,data_czas) VALUES (39,90,2,sysdate);
INSERT INTO Status_paczki (id_statusu,id_paczki,id_lokalizacji,data_czas) VALUES (40,52,9,sysdate);